package com.Jihye.jdbc.template;
...
import com.Jihye.jdbc.raw.Article;
import com.Jihye.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/jihyedb?user=jihye&password=06170617");
